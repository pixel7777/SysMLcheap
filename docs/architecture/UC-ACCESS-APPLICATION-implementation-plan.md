...
2. Implement entry decision logic (independent from AI availability state).
...
5. Show AI capability warning banner in-app only (post-entry).
6. Add automated tests for core routing scenarios.
...
- If degraded flag is on, do I still enter normally and see only an in-app AI capability banner?
